...
import { adminPaths, isAdminPathActive } from '@/adminPaths';

const page = usePage();
const admin = computed(() => page.props.auth?.admin || page.props.auth?.user || { name: 'مدير النظام' });
...
const navigation = [
    {
        ...
        match: [adminPaths.dashboard],
        icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
    },
    {
        name: 'المكاتب',
        href: adminPaths.tenants,
        match: [adminPaths.tenants],
        icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
    },
    {
        name: 'فواتير الاشتراكات',
        href: adminPaths.invoices,
        match: [adminPaths.invoices],
        icon: 'M9 14l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
    },
    {
        name: 'المديرين',
        href: adminPaths.admins,
        match: [adminPaths.admins],
        icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
    },
];

const isActive = (item) => isAdminPathActive(item.match);

const logout = () => {
    router.post(adminPaths.logout);
};
...
<template>
    <div class="min-h-screen bg-stone-50 font-sans dark:bg-slate-950 transition-colors duration-300">
        ...
        <div class="lg:mr-[270px]">
            ...
            >
                <div v-if="flash.success || $page.props.flash?.success" class="mx-6 mt-4">
