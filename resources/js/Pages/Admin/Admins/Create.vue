...
<template>
    <Head title="إضافة مدير جديد" />

    <AdminLayout>
        <template #title>إضافة مدير جديد</template>
        ...
        <div class="max-w-2xl">
            <div class="bg-white rounded-2xl border border-stone-200/80 p-8">
                <div class="mb-8">
                    <h2 class="text-xl font-bold text-stone-800">بيانات المدير</h2>
                    <p class="text-sm text-stone-400 mt-1">أدخل بيانات المدير الجديد لإنشاء حسابه</p>
                </div>
