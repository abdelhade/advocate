...
<template>
    <Head title="إضافة قضية جديدة" />

    <TenantLayout>
        <template #title>إضافة قضية جديدة</template>
        ...
        <div class="flex items-center gap-2 text-sm text-stone-400 mb-6">
            ...
            <span class="text-stone-600 font-medium">إضافة قضية</span>
        </div>
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-stone-800 mb-4 pb-2 border-b border-stone-100 flex items-center gap-2">
                            <span class="w-6 h-6 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center text-sm font-bold">1</span>
                            البيانات الأساسية
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Case Number -->
                            <div>
                                <label for="case_number" class="block text-sm font-semibold text-stone-700 mb-2">
                                ...
                                <input
                                    ...
                                    :class="{ 'border-red-500 ring-1 ring-red-500': form.errors.case_number }"
                                />
                                <p v-if="form.errors.case_number" class="mt-1.5 text-sm text-red-600">{{ form.errors.case_number }}</p>
                            </div>

                            <!-- Title -->
                            <div>
                                <label for="title" class="block text-sm font-semibold text-stone-700 mb-2">
                                    موضوع القضية <span class="text-red-500">*</span>
                                </label>
                                <input
                                    id="title"
                                    type="text"
                            ...
                            <!-- Client -->
                            <div>
                                <label for="client_id" class="block text-sm font-semibold text-stone-700 mb-2">
                                    الموكل <span class="text-red-500">*</span>
                                </label>
                                <select
                                    id="client_id"
                                    ...
                                    :class="{ 'border-red-500 ring-1 ring-red-500': form.errors.client_id }"
                                >
                                    <option value="" disabled>اختر الموكل...</option>
                            ...
                            <!-- Case Type -->
                            <div>
                                <label for="case_type" class="block text-sm font-semibold text-stone-700 mb-2">
                                    نوع القضية <span class="text-red-500">*</span>
                                </label>
                                <select
                                    id="case_type"
                    ...
                    <div>
                        <h3 class="text-base font-bold text-stone-800 mb-4 pb-2 border-b border-stone-100 flex items-center gap-2">
                            <span class="w-6 h-6 rounded-lg bg-emerald-100 text-emerald-700 flex items-center justify-center text-sm font-bold">2</span>
                            البيانات القضائية
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Status -->
                            <div>
                                <label for="status" class="block text-sm font-semibold text-stone-700 mb-2">
                                    حالة القضية <span class="text-red-500">*</span>
                                </label>
                                <select
                                    id="status"
                                    v-model="form.status"
                    ...
                    <div>
                        <h3 class="text-base font-bold text-stone-800 mb-4 pb-2 border-b border-stone-100 flex items-center gap-2">
                            <span class="w-6 h-6 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center text-sm font-bold">3</span>
                            تفاصيل إضافية
                        </h3>
                        <div>
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="w-full px-4 py-3 rounded-xl border border-stone-300 bg-stone-50 text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none"
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 pt-6 border-t border-stone-100">
                        <button
                            ...
                            class="inline-flex items-center gap-2 px-6 py-3 bg-blue-700 hover:bg-blue-800 text-white text-sm font-bold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-blue-200"
                        >
                            ...
                            {{ form.processing ? 'جارٍ الحفظ...' : 'حفظ القضية' }}
                        </button>
                        <Link :href="route('cases.index')" class="px-6 py-3 border border-stone-200 text-stone-600 text-sm font-semibold rounded-xl hover:bg-stone-50 transition-colors">
                            إلغاء
                        </Link>
                    </div>
                </form>
